...
class LayoutFlatFixed: public Layout
{
    public:
        ...
        LayoutFlatFixed(DynamicPosition dynamicPosition, unsigned int width, unsigned int height, double horizontalAngleOfVision): Layout(width,height),
            m_dynamicPosition(std::move(dynamicPosition)), m_horizontalAngleOfVision(horizontalAngleOfVision),
            m_verticalAngleOfVision(height*horizontalAngleOfVision/width), m_maxHDist(2.f*std::tan(m_horizontalAngleOfVision/2)),
