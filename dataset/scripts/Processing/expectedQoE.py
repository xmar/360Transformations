            ...
            for nbQec in range(1,33):
                ...
                for random in randoms:
                    ...
                    for videoId in drDict:
                        ...
                        r = dr.ComputeAllPositionsWithTimestamp(window, qecReader, nbQec, random)
                    ...
                    #compute the QoE
                    for videoId in dic:
                        r = ComputeExpectedLiveQoE('{}/{}nbQec{}window{}RandomId{}.csv'.format(pathToOutput, videoId, nbQec, window, random if random is not None else 0), dic[videoId], distToQoEReader, layout, window)
