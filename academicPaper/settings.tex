...
\begin{itemize}
   ...
   used to assess the objective video quality.
...
between the \acp{QER} and the \FoV{} centers. Note %also
that a
significant part of these gains stems from the cube map layout. %projection.
