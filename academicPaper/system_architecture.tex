...
%The center of the \FoV{} is a point on the
...
%\FoV{} center for the next $x$ seconds.
...
% and \texttt{quality} \texttt{arrangement} attributes, to notify
