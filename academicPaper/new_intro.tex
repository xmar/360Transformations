...
%Furthermore,  the \ac{HMD} 
%vendors recommend to make the system react to head movement as fast as 
%Sending only \ac{FoV} videos does
%not enable fast
%navigation within the 360-degree video: When the client moves the head, the \ac{FoV} 
%center changes, requiring a new \ac{FoV} video to be immediately displayed. However, since 
