...
Head-Mounted Displays (HMDs) presents a number of technical
...
portion of this scene is displayed at any time on the user's HMD. The
delivery of such videos wastes network resources since most of the
pixel data are never used. With high refresh rates, HMDs need to
...
required immense video bitrate, while still providing an immersive
...
multiple video representations that differ not only by their bitrate,
...
bitrate fits the available throughput and a full quality region
...
the best quality for the given bitrate budget. An evaluation with a
