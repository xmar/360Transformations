...
\begin{tikzpicture}
   ...
   \def\sizeSphere{55}
   \only<+->{
      \def\angleRot{-20}   \def\distanceH{0.6}   \def\distanceV{0.5}   \def\offsetFoVH{0}   \def\offsetFoVV{0}
   }
   \only<+>{
      \def\angleRot{-160}                                               \def\offsetFoVH{-1}   \def\offsetFoVV{0}
   }
   \only<+>{
      \def\angleRot{160}                                               \def\offsetFoVH{-1}   \def\offsetFoVV{1}
   }
   \only<+>{
      \def\angleRot{20}                                               \def\offsetFoVH{0}   \def\offsetFoVV{1}
   }
   %%%%%%%%%%%%%%%
   \only<+->{
   ...
   \only<+>{
      \def\angleRot{-160}                                               \def\offsetFoVH{-2}   \def\offsetFoVV{-1}
   }
   \only<+>{
      \def\angleRot{160}                                               \def\offsetFoVH{-2}   \def\offsetFoVV{2}
   }
   \only<+>{
   ...
   %%%%%%%%%%%%%%%%
   \only<+->{
      \def\angleRot{-20}   \def\distanceH{1.2}   \def\distanceV{1.0}   \def\offsetFoVH{2}   \def\offsetFoVV{-2}
   }
   \only<+>{
      \def\angleRot{-160}                                              \def\offsetFoVH{-2.8}   \def\offsetFoVV{-2}
   }
   \only<+>{
      \def\angleRot{160}                                               \def\offsetFoVH{-2.8}   \def\offsetFoVV{2.8}
   }
   \only<+>{
      \def\angleRot{20}                                               \def\offsetFoVH{2}   \def\offsetFoVV{2.8}
   }
   ...
   \tikzset{
   	sphericalMetric/.pic={
         ...
         \node[anchor=west] at (FoV) {\tiny FoV};
       }
   }
   \tikzset{
