         ...
         \begin{column}{0.5\linewidth}
            ...
            \begin{itemize}
               ...
               \begin{itemize}
                  ...
                  \item Motion-to-photon issues: 5-20\,ms to prevent motion sickness
               \end{itemize}
            \end{itemize}
            }
         \end{column}
      ...
      \begin{columns}[T]
            ...
            \only<11->{
               \begin{itemize}
                  ...
                  \begin{itemize}
                     ...
                     \item Flexibility
                     \item Compliant with DASH Spatial Relationship Description
                  \end{itemize}
               \end{itemize}
            }
         \end{column}
         \begin{column}{0.5\linewidth}
            ...
            \begin{itemize}
               \item \textbf{Weaknesses}:
               \begin{itemize}
                  \item More processing at the client side
