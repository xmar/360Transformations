...
\begin{tikzpicture}
    \begin{axis}[
            ylabel={PSNR gap with AverageEqui},
...
%            axis on top,
        ...
        y=qualityEquirectangularTiled]{results/distanceQuality_psnr.csv};
        \addplot+ table [x=distance,
        y=qualityCubMap]{results/distanceQuality_psnr.csv};
        \addplot+ table [x=distance,
        y=qualityPyramidal]{results/distanceQuality_psnr.csv};
        \addplot+ table [x=distance,
        y=qualityRhombicDodeca]{results/distanceQuality_psnr.csv};
        \legend{EqTiled,CubeMap,Pyramid,RhombicDodeca}
