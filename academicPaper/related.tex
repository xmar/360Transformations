...
video, the delivery solution that has been recently studied leverages the concept
of \emph{tiling}, notably for navigable panorama
...
\parag{Our contributions}In our \GS{proposal}, the server 
...
\parag{Our contributions}Our proposal is based on the same
