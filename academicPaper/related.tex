...
video (navigable panorama
video~\cite{sanchez_compressed_2015,wang_mixing_2014,gaddam_tiling_2015}
and large-resolution video~\cite{jean16mmsys}), the delivery solution that has been recently studied leverages the concept
of \emph{tiling}}.
...
\GS{The spherical video is projected into a pyramid layout from multiple 
