...
A  360-degree video provider (Facebook) has
...
\GS{The spherical video is projected onto a pyramid layout from 
up to 30 central points to generate a set of representations.
Since the
...
\GS{However, as seen in Section~\ref{sec:settings}, the pyramid projection is not
