...
\citet{lee2011efficient} studied in an other context the coding of a regular
video with a \ac{QER}. The \ac{QER} is generated near the area that is more likely
to attract gazes. They do not propose to generate representations with different
\ac{QER}.
