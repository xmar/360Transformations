...
\parag{Our contributions} In our proposal, the server always delivers
...
\parag{Our contributions} In our proposed system, the server prepares
...
\XC{Moreover, they do not show the impact of the encoding on the
performance of their projections.}{}

\parag{Our contributions} The solution we propose is based on the same
...
analysis of the best number of \ac{QEC} representations to
use,}{} and a first step towards integration into MPEG \ac{DASH}.
