...
videos combine a very large resolution (up to 12K) and a very
...
\begin{figure}%[h]
   ...
   gray the low quality. The viewport is the dotted red rectangle, the \ac{FoV} center the
   cross}
   \label{fig:deliverychain}
\end{figure}

Viewport-adaptive 360-degree streaming system has three
